...
import {
  fetchAllOrders,
  updateOrderStatus,
} from "../../redux/adminOrder/adminOrderThunks";
                ...
                >
                  ...
                  <td className="p-4">
                    <select
                      ...
                      className="border border-gray-300 bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5"
                    >
