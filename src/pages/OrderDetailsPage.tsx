...
import { fetchOrderDetails } from "../redux/order";
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      {!orderDetails ? (
        ...
        <div className="p-4 md:p-6 rounded-lg border border-gray-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
